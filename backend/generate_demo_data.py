...
ETF_CONFIG = {
    # 美股大盤（包含基準）
    'SPY': {'base_price': 320.0, 'annual_return': 0.11, 'volatility': 0.17, 'dividend_yield': 0.016},
    ...
    'DGRO': {'base_price': 28.0, 'annual_return': 0.10, 'volatility': 0.16, 'dividend_yield': 0.025},
    'HDV': {'base_price': 65.0, 'annual_return': 0.09, 'volatility': 0.15, 'dividend_yield': 0.035},
    ...
    # 科技/英股
    'CNDX': {'base_price': 12.0, 'annual_return': 0.15, 'volatility': 0.22, 'dividend_yield': 0.0},
    'EQQQ': {'base_price': 22.0, 'annual_return': 0.15, 'volatility': 0.22, 'dividend_yield': 0.0},
    'IUMO': {'base_price': 15.0, 'annual_return': 0.13, 'volatility': 0.20, 'dividend_yield': 0.008},
    'QMOM': {'base_price': 45.0, 'annual_return': 0.12, 'volatility': 0.19, 'dividend_yield': 0.010},
}
